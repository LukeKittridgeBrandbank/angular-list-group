(function (window, document) {
  ...
  listGroupFilters.filter('startsWith', [
    '$filter',
    function ($filter) {
  ...
  listGroupFilters.filter('endsWith', [
    '$filter',
    function ($filter) {
      return function (str, text, ignoreCase) {
  ...
  listGroupFilters.filter('contains', [
    '$filter',
    function ($filter) {
  ...
  listGroupDirectives.directive('listGroup', [
    '$templateCache',
  ...
  listGroupDirectives.directive('listGroupEditor', [
    '$templateCache',
    function ($templateCache) {
      return {
        restrict: 'EA',
